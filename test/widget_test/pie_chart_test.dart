...
void main() {
  testWidgets('CustomPieChart Widget Test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: CustomPieChart(crops: testCrops),
      ),
    );

    // Verify that the chart title is displayed
    expect(find.text('Global Crop Distribution by Country'), findsOneWidget);

    // Verify that the SfCircularChart widget is present
